...
import './ServCar.css';
import imp1 from '/images/sap-imp-1.jpg'
import imp2 from '/images/sap-imp-2.jpg'
import imp3 from '/images/sap-imp-3.jpg'
import imp4 from '/images/sap-imp-4.jpg'
import imp5 from '/images/sap-imp-5.jpg'
...
const ImplementationServices = () => {
    ...
    return (
        <>
                        ...
                        <div className="carousel-wrapper">
                            <div className="carousel-track">
                                {teamMembers.map((member, index) => {
                                    ...
                                    const adjustedPos = relativePos > teamMembers.length / 2
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className={`card-gradient ${isActive ? 'active' : ''}`} />
            ...
            <section className="metric-overlay">
                            ...
                            <div className="col-md-4">
                                <div className="metric-card text-center">
                                    <div className="metric-content">
                                        <h2>99%</h2>
                                        <p>Of project delivered within agreed timeline</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="metric-card text-center">
                                    <div className="metric-content">
                                        <h2>40+</h2>
                                        <p>Go-live delivered earlier than planned</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="metric-card text-center">
                                    <div className="metric-content">
                                        <h2>20%</h2>
                                        <p>Reduction in overall implementation time</p>
                                    </div>
                                </div>
                            </div>
                        </div>
